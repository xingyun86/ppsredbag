 ...
 */
public class QQAccessbilityJob extends BaseAccessbilityTaskJob {
    ...
    /** 红包消息的关键字*/
    private static final String QQ_REDBAG_TEXT_KEY = "[QQ红包]";
    ...
    private final static String QQ_REDBAG_PASSWORD = "口令红包";
        ...
        if(eventType == AccessibilityEvent.TYPE_NOTIFICATION_STATE_CHANGED) {
            ...
            if(!texts.isEmpty()) {
                for(CharSequence t : texts) {
                    ...
                    if(text.contains(QQ_REDBAG_TEXT_KEY)) {
                        openNotify(event);
                        break;
                    }
                }
                    ...
                    if(sDelayTime != 0) {
                        getHandler().postDelayed(new Runnable() {
                            ...
                            public void run() {
                                ...
                                if (n.getText().toString().equals(QQ_REDBAG_PASSWORD)) {
  ...
  /* 聊天会话窗口，遍历节点匹配“点击拆开”，“口令红包”，“点击输入口令” */
        List<AccessibilityNodeInfo> nodes1 = this.findAccessibilityNodeInfosByTexts(this.rootNodeInfo, new String[]{QQ_DEFAULT_CLICK_OPEN, QQ_REDBAG_PASSWORD, QQ_CLICK_TO_PASTE_PASSWORD, "发送"});
        if (!nodes1.isEmpty()) {
